...
def test_ttnn_routed_expert(
        ...
        for ds in range(dispatch_group_size):
            ...
            for expert_idx in range(experts_per_chip):
                ...
                if token_count > 0:
                    ...
                    # padding (e.g. when the op allocates the output with ttnn::empty).
    ...
    # uninitialized by design and not part of the contract — see the per-expert
    # check above and the comment in unified_routed_expert_ffn.cpp.
