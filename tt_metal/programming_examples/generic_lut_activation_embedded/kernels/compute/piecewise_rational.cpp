...
template <uint32_t NUM_DEGREE, uint32_t DEN_DEGREE>
inline void eval_rational_interleaved_numer_denom(const float* num_coeffs, const float* den_coeffs,
                                                   vFloat x, vFloat& out_numer, vFloat& out_denom) {
    constexpr uint32_t MIN_DEG = (NUM_DEGREE < DEN_DEGREE) ? NUM_DEGREE : DEN_DEGREE;
...
template <uint32_t NUM_DEGREE, uint32_t DEN_DEGREE>
inline void eval_rational_parity_numer_denom(const float* num_coeffs, const float* den_coeffs,
                                              vFloat x, vFloat x2, vFloat& out_numer, vFloat& out_denom) {
    constexpr int NUM_TOP = (NUM_DEGREE % 2 == 1) ? NUM_DEGREE : NUM_DEGREE - 1;
    constexpr int DEN_TOP = (DEN_DEGREE % 2 == 0) ? DEN_DEGREE : DEN_DEGREE - 1;
...
#else
#if defined(RANGE_REDUCTION_EXP) || defined(RANGE_REDUCTION_TRIG) || defined(RANGE_REDUCTION_LOG)    return eval_rational_interleaved<NUM_DEGREE, DEN_DEGREE>(num_coeffs, den_coeffs, x);
#else
...
template <uint32_t NUM_DEGREE, uint32_t DEN_DEGREE>
inline void eval_rational_numer_denom(const float* num_coeffs, const float* den_coeffs,
                                       vFloat x, vFloat& out_numer, vFloat& out_denom
#if defined(RATIONAL_NUM_PARITY_ODD) && defined(RATIONAL_DEN_PARITY_EVEN)
                                       , vFloat x2
#endif
