...
STORAGE_HELPER_VERSION="${STORAGE_HELPER_VERSION:-0.1.2}"
# SHA256 for ccache-storage-s3-go-0.1.2-linux-amd64.tar.gz
# Verified by downloading from GitHub releases and running sha256sum.
STORAGE_HELPER_SHA256="${STORAGE_HELPER_SHA256:-f8302ffea0c0e6759ca938131ab144202b88d641f57cb5ba74587c3fa30afc5a}"
